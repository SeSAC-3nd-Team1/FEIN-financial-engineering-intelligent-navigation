...
function RebalanceAlertsContent({
  userName,
  strategy,
  onNavigate,
  onBack,
            ...
            {usingRealAlerts && (
              <div className="flex flex-col gap-2.5 rounded-[18px] bg-[#F8FCEE] px-8 py-7">
                ...
                <p className="text-[17px] leading-7 text-[#3F4A43]">
                  특정 종목의 영향이 커져 {strategy.name}보다 포트폴리오가 더
                  많이 흔들릴 수 있어요.
                </p>
              </div>
            )}
