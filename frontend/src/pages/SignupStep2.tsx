...
export default function SignupStep2({
  email, verified, expiresInSeconds, onResend, onVerify, onContinue, onBack, userName, onNavigate,
}: Props) {
  ...
  useEffect(() => { if (!verified) timer.start(); }, [verified]);
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <button onClick={() => void handleResend()} disabled={resending} className="self-start text-[15px] text-subtle underline disabled:cursor-default">
        인증번호 다시 받기
      </button>
