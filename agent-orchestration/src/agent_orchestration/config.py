...
class Settings(BaseSettings):
    ...
    agent_client_backend: Literal["foundry_sdk", "direct_http"] = "foundry_sdk"
    ...
    chatbot_registry_path: Path | None = None
    chatbot_registry_json: str | None = Field(default=None, repr=False)

    @field_validator(
        "chatbot_registry_path", "chatbot_registry_json", mode="before"
    )
    @classmethod
    def empty_chatbot_registry_values_are_unset(cls, value):
